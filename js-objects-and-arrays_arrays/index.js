...
const exampleArray = [true, "String", 1];
console.log("result", exampleArray);
...
console.log("result", nestedNumbers);
...
console.log("result", petsWithPush);
...
fruitsWithPop.pop();
console.log("result", fruitsWithPop);
...
console.log("result", unshiftedPets);
...
shiftedFruits.shift();
console.log("result", shiftedFruits);
export {
  exampleArray,
  nestedArray,
  firstNumber,
